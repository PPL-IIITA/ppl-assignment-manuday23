...
To run the code on a random input type the following command in terminal/command line : java -jar "Q1_Main.jar"
...
To run the code on a random input type the following command in terminal/command line : java -jar "Q2_Main.jar"
